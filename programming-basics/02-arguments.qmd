...
Here we see that the `log` function recognizes two arguments, one named `x` and one named `base`. 
...
You can use these names to look up what the arguments do, for example in `log`'s help page.
